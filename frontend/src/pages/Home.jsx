    ...
    <div className=''>
      {loading && (
          <div className='text-center'>
            <svg aria-hidden='true' className='inline w-8 h-[80vh] text-background animate-spin fill-text' viewBox='0 0 100 101' fill='none' xmlns='http://www.w3.org/2000/svg'>
      ...
      <div className='text-text p-5 max-w-[1400px] items-center justify-between mx-auto flex'>
        ...
        {!loading && <div className='mr-[5rem] align-top mb-[800px]'>
          <WorkoutForm />
        </div>}
      </div>
    </div>
