...
const Main = () => {
  ...
  return (
    <div className=''>
      ...
      {!loading && (
        <div className='grid place-items-center'>
          <button className="btn btm-sm bg-[#19191aa8] text-gray-300 hover:bg-green-800 hover:text-white hover:border border-[#3a645d86] " onClick={modalOpen}>Add an Exercise</button>
        </div>
      )}
