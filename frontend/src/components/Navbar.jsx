    ...
    <header className='bg-background text-text'>
      <div className='container font-dm max-w-[1400px] mx-auto my-0 flex items-center p-3 justify-between'>
        <div className='flex group'>
          <svg aria-hidden='true' focusable='false' data-prefix='fas' data-icon='dumbbell' className='svg-inline--fa fa-dumbbell fa-lg w-8 group-hover:text-[#81837e] transition-all duration-500 ease-in-out' role='img' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 640 512'>
          ...
          <Link to='/'>
            <h1 className='text-2xl pl-2 font-pt tracking-tighter group-hover:text-[#81837e] transition-all duration-500 ease-in-out'>focused.</h1>
          </Link>
        </div>
